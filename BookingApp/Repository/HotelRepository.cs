...
namespace BookingApp.Repository
{
    public class HotelRepository : IHotelRepository
    {
        ...
        {
            return await _database.HotelTipCamere.ToListAsync();
        }

        public async Task<List<HotelTipCameraPret>> GetAllHotelsTipCameraPret()
        {
            return await _database.HotelTipCameraPreturi.ToListAsync();
        }

        public async Task<List<HotelTipCameraPretReview>> GetAllHotelsByRating()
        {
            return await _database.HotelTipCameraPretReviews.ToListAsync();
        }
